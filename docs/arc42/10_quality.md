...
| ----------------------------- | -------------------------------------------------------------------------------------------------------- |
| Reliability                   | Recipes and ingredients are displayed accurately; the app stays usable when the Weather API is down.     |
...
| ----- | --------------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| QS-01 | Performance     | A user opens the app → it is interactive in under 2 s; any in-app action responds in under 1 s.                                           |
| QS-02 | Reliability     | The Weather API is unavailable → the weather widget shows an error message and the rest of the app stays fully usable.                    |
