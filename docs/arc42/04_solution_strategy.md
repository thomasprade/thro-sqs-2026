...
| --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Reliability                                               | The local SQLite store gives deterministic reads/writes. Calls to the external Weather API are isolated with a circuit-breaker fallback (opossum) so the rest of the app stays usable when the Weather API is down.                   |
